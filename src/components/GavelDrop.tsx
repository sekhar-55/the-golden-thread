    ...
    <div ref={containerRef} className="relative">
      ...
      <div className="flex justify-center mb-6">
        <div ref={gavelRef} className="relative opacity-0">
          <span className="text-5xl"><svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#000000" version="1.1" id="Capa_1" width="50px" height="50px" viewBox="0 0 492.508 492.508" xmlSpace="preserve">
<g>
	<g>
