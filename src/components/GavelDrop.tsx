    ...
    <div ref={containerRef} className="relative">
      ...
      <div className="flex justify-center mb-6">
        <div ref={gavelRef} className="relative opacity-0">
          <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#d6a971cc" version="1.1" id="Capa_1" width="50px" height="50px" viewBox="0 0 492.508 492.508" xmlSpace="preserve">
<g>
	<g>
        ...
        <span className='gavelstand'>
          <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#d6a971cc" version="1.1" id="Capa_1" width="50px" height="50px" viewBox="0 0 492.508 492.508" xmlSpace="preserve" preserveAspectRatio="xMidYMin meet">
            <g>
              <g>
